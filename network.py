...
class Bond:
    ...
    def __init__(self, atom1: Atom, atom2: Atom, length: float | None = None, bond_coefficient: float | None = None):
        ...
        self.bond_coefficient = 1 / (self.length**2) if bond_coefficient is None else bond_coefficient
